...
| S1–S2 | M1 | Arnés · métricas · test anti-leakage · clasificador de cuadrantes | M1.0–M1.4 | 🟡 2026-07-27 — **M1.0 ✅** (§5.1: los 9 defectos del relevamiento, con test de regresión cada uno), **M1.1 ✅** (arnés + corridas identificadas) y **M1.3 ✅** (red anti-leakage, `pytest -m innegociable`). **M1.2 🟡**: entregado salvo el corte por cuadrante, que depende de M1.4. 59 tests verdes, ningún `xfail`. Pendiente: **M1.4** (clasificador ADI/CV², que además cierra M1.2) |
