...
- **Falta de M1.0 solo el ítem (g):** identificador de corrida + función de reporte con los cortes 1/3/6/12. Hasta entonces **no se congela el piso de baselines** (M1.7/M1.8): no hay trazabilidad de qué configuración produjo qué número.
